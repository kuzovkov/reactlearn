...
useState  - хорош для локальных данных, короткоживущих
useReducer - хорош для общих данных, которые необходимо обновлять
useContext - хорош для создания контекста

в useReducer не нужно вставлять асинхронный код

### Безопасность в React: защита от XSS и работа с чувствительными данными. Подсветка фрагмента поиска
react по-умолчанию экранирует строки (скрипты и html)
<span dangerouslySetInnerHTML={{ __html: '<script>alert("XSS")</script>' }} />
